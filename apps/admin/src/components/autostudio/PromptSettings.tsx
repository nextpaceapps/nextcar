...
export const PromptSettings: React.FC<PromptSettingsProps> = ({
  ...
  const promptFieldClassName =
    'w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-[15px] leading-7 text-slate-800 shadow-sm outline-none transition-all placeholder:text-slate-400 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 resize-y';
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-slate-50 p-4 shadow-sm">

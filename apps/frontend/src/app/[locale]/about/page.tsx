    ...
    <StaticPageLayout>
      <article>
        ...
        <section className="space-y-8 mb-12">
          ...
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">{t('ourStoryText')}</p>
        </section>
        ...
        <section className="space-y-8 mb-12">
          ...
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">{t('missionText')}</p>
        </section>

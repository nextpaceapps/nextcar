      ...
      <article>
        ...
        <section className="space-y-10 mb-16">
          ...
          <ol className="space-y-8">
            <li className="flex gap-6">
              <span className="flex-shrink-0 w-12 h-12 rounded-full bg-primary dark:bg-white text-white dark:text-primary font-bold flex items-center justify-center">
                1
              </span>
              <div>
            ...
            <li className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">{t('step4Text')}</p>
              </div>
            </li>
          </ol>
        </section>
        ...
        <section className="space-y-8 mb-16">
          ...
          <dl className="space-y-8">
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white mb-2">{t('faq1Q')}</dt>
              <dd className="text-slate-600 dark:text-slate-400">{t('faq1A')}</dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white mb-2">{t('faq2Q')}</dt>
              <dd className="text-slate-600 dark:text-slate-400">{t('faq2A')}</dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white mb-2">{t('faq3Q')}</dt>
              <dd className="text-slate-600 dark:text-slate-400">{t('faq3A')}</dd>
            </div>
          </dl>
        </section>
        ...
        <section className="pt-8 border-t border-slate-200 dark:border-slate-800">
          ...
          <p className="text-slate-700 dark:text-slate-300 mb-6">{t('trustText')}</p>
          <Link
            href="/vehicles"

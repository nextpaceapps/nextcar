    ...
    <header className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-6 mt-4">
        <div className="flex flex-wrap items-baseline gap-3">
          ...
          {showOldPrice && (
            <span className="text-xl sm:text-2xl text-slate-400 dark:text-slate-500 line-through font-display">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="#inquiry-form"
            className="text-center bg-primary text-white py-3 px-7 rounded-full font-bold uppercase tracking-widest text-sm hover:-translate-y-0.5 transition-transform active:scale-[0.98] shadow-lg shadow-primary/25 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-slate-900"
          >
            {t('imInterested')}
          </a>
          <Link
            ...
            scroll={false}
            className="text-center bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-3 px-7 rounded-full font-bold uppercase tracking-widest text-sm hover:bg-slate-700 dark:hover:bg-slate-100 transition-colors active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
          >
            {t('scheduleTestDrive')}
          </Link>
        </div>

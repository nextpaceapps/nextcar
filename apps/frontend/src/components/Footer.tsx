      ...
      <div className="bg-black text-white rounded-xlarge p-10 lg:p-20 flex flex-col min-h-[500px] justify-between relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-4 mb-20">
            <button className="bg-white text-black px-10 py-5 rounded-2xl font-bold text-lg hover:bg-slate-100 transition-all hover:-translate-y-1 active:scale-95 shadow-xl shadow-white/5">
              Get a quote
            </button>
            <button className="bg-[#2a2a2a] text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-[#333333] transition-all hover:-translate-y-1 active:scale-95">
              Book a consultation
            </button>
          </div>
        </div>
